...
> em 2026-08-02 (v2.61.0); demais fatos podem estar defasados — remeça por comando ao editar.
>
...
- **Versão:** 2.61.0 (`package.json:3` — incrementar a cada atualização; exposta em `/api/version`)
