...
> em 2026-08-02 (v2.63.0); demais fatos podem estar defasados — remeça por comando ao editar.
>
...
- **Versão:** 2.63.0 (`package.json:3` — incrementar a cada atualização; exposta em `/api/version`)
...
npm run test         # vitest run — 205/205 passam (16 arquivos: scoring, adaptive, compra-missoes, focus, vigilancia, informacao-foco, ...)
