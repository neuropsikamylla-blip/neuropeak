...
> em 2026-08-02 (v2.65.1); demais fatos podem estar defasados — remeça por comando ao editar.
>
...
- **Versão:** 2.65.1 (`package.json:3` — incrementar a cada atualização; exposta em `/api/version`)
