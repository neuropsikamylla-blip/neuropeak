...
const ROTEIRO: Partial<Record<TemaKey, Cena[]>> = {
  frio: [
    ...
    { fundo: "vila-roupa", cat: ["frio"], titulo: "Ainda faltam peças para aguentar o frio.", corpo: "Separou mais algumas roupas quentes. Quanto custam juntas?" },
    { fundo: "aeroporto", cat: ["alimento"], titulo: "No aeroporto, esperando o voo.", corpo: "Comprou um lanche e pagou com uma nota. Quanto recebe de troco?" },
    { fundo: "aeroporto", cat: ["alimento"], titulo: "A viagem vai ser longa.", corpo: "Tem um limite de dinheiro para os lanches do voo. Escolha sem estourar." },
    { fundo: "frio", cat: ["frio"], titulo: "Chegou ao destino gelado!", corpo: "Vai fazer frio todos os dias — leva vários pares iguais de meia." },
    { fundo: "supermercado", cat: ["fruta"], titulo: "Compras no mercado do vilarejo.", corpo: "Comprou frutas para dividir igualmente com os amigos da viagem." },
    { fundo: "frio", cat: ["frio"], titulo: "Arrumando a mochila para a neve.", corpo: "Quer saber o peso do que vai carregar nas costas." },
    { fundo: "frio", cat: ["frio"], titulo: "A mala aguenta um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "frio", cat: ["objeto"], titulo: "Nem tudo cabe na mala.", corpo: "Escolha o que levar sem passar do peso permitido." },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "Última ida ao supermercado.", corpo: "Comprou comida para os dias, cuidando do dinheiro E do peso da sacola." },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "Fechando as compras da viagem.", corpo: "Falta só respeitar todas as regras." },
  ],
  ...
  praia: [
    ...
    { fundo: "shopping", cat: ["praia"], titulo: "Ainda faltam algumas coisas para a praia.", corpo: "Escolheu mais itens. Quanto custam juntos?" },
    { fundo: "estacao", cat: ["bebida"], titulo: "A caminho do litoral.", corpo: "Na estação, comprou uma água e pagou com uma nota. Quanto recebe de troco?" },
    { fundo: "estacao", cat: ["bebida", "alimento"], titulo: "A viagem até o mar é longa.", corpo: "Tem um limite de dinheiro para os lanches. Escolha sem estourar." },
    { fundo: "praia", cat: ["bebida"], titulo: "Chegou à praia!", corpo: "Estava calor — comprou várias bebidas geladas iguais para o grupo." },
    { fundo: "praia", cat: ["fruta"], titulo: "Hora do lanche na areia.", corpo: "Comprou frutas para dividir igualmente com os amigos." },
    { fundo: "praia", cat: ["praia"], titulo: "Arrumando a bolsa de praia.", corpo: "Quer saber o peso do que vai carregar até a areia." },
    { fundo: "praia", cat: ["praia"], titulo: "A bolsa aguenta um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "praia", cat: ["objeto"], titulo: "Nem tudo cabe na bolsa.", corpo: "Escolha o que levar sem passar do peso." },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "Passando no mercadinho da praia.", corpo: "Comprou o lanche cuidando do dinheiro E do peso da sacola." },
    { fundo: "praia", cat: ["praia", "bebida"], titulo: "Últimas compras antes de ir embora.", corpo: "Falta só respeitar todas as regras." },
  ],
  ...
  piquenique: [
    ...
    { fundo: "padaria", cat: ["alimento"], titulo: "Passando na padaria.", corpo: "Pegou pães e um bolo para o lanche. Quanto custam juntos?" },
    { fundo: "supermercado", cat: ["bebida"], titulo: "Faltam as bebidas.", corpo: "No mercado, comprou sucos e pagou com uma nota. Quanto de troco?" },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "A cesta não pode ficar cara.", corpo: "Tem um limite de dinheiro para o piquenique. Escolha sem estourar." },
    { fundo: "vila-fruta", cat: ["fruta"], titulo: "Vão muitos amigos ao parque!", corpo: "Vai levar várias frutas iguais para todo mundo." },
    { fundo: "neutro", cat: ["fruta"], titulo: "Chegaram ao parque!", corpo: "Dividiu as frutas igualmente entre os amigos." },
    { fundo: "neutro", cat: ["alimento", "fruta"], titulo: "Montando a cesta de piquenique.", corpo: "Quer saber o peso de tudo o que vai levar." },
    { fundo: "neutro", cat: ["fruta"], titulo: "A cesta tem um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "neutro", cat: ["objeto"], titulo: "Nem tudo cabe na cesta.", corpo: "Escolha o que levar sem passar do peso." },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "Última parada no mercado.", corpo: "Completou o lanche cuidando do dinheiro E do peso." },
    { fundo: "neutro", cat: ["fruta", "alimento"], titulo: "Tudo pronto para o piquenique.", corpo: "Falta só respeitar as regras." },
  ],
  ...
  alimentos: [
    ...
    { fundo: "vila-fruta", cat: ["fruta"], titulo: "Falta a sobremesa.", corpo: "Comprou frutas para o doce. Quanto custam juntas?" },
    { fundo: "padaria", cat: ["alimento"], titulo: "Passando na padaria.", corpo: "Levou pão fresco e pagou com uma nota. Quanto de troco?" },
    { fundo: "supermercado", cat: ["alimento"], titulo: "Ainda faltam alguns itens.", corpo: "Tem um limite de dinheiro para o almoço. Escolha sem estourar." },
    { fundo: "supermercado", cat: ["alimento"], titulo: "A família é grande!", corpo: "Vai levar vários iguais para todos." },
    { fundo: "cozinha", cat: ["fruta"], titulo: "De volta à cozinha.", corpo: "Dividiu as frutas igualmente nos pratos da sobremesa." },
    { fundo: "cozinha", cat: ["legume"], titulo: "Preparando a panela.", corpo: "Pesa os legumes antes de cozinhar." },
    { fundo: "feira", cat: ["legume"], titulo: "A sacola tem um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "supermercado", cat: ["alimento"], titulo: "Nem tudo cabe na sacola.", corpo: "Escolha o que levar sem passar do peso." },
    { fundo: "supermercado", cat: ["alimento", "legume"], titulo: "Última ida ao mercado.", corpo: "Completou as compras cuidando do dinheiro E do peso." },
    { fundo: "cozinha", cat: ["alimento", "fruta"], titulo: "Tudo pronto para o almoço.", corpo: "Falta só respeitar as regras." },
  ],
  ...
  mercado: [
    ...
    { fundo: "vila-fruta", cat: ["fruta"], titulo: "Passando no hortifruti.", corpo: "Escolheu frutas da estação. Quanto custam juntas?" },
    { fundo: "farmacia", cat: ["higiene"], titulo: "Uma parada na farmácia.", corpo: "Comprou itens de higiene e pagou com uma nota. Quanto de troco?" },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "A conta da semana não pode passar.", corpo: "Tem um limite de dinheiro. Escolha sem estourar." },
    { fundo: "padaria", cat: ["alimento"], titulo: "Na padaria do bairro.", corpo: "Vai levar vários iguais para a semana toda." },
    { fundo: "feira", cat: ["fruta"], titulo: "De passagem pela feira.", corpo: "Dividiu as frutas igualmente entre os filhos." },
    { fundo: "supermercado", cat: ["alimento"], titulo: "Pesando o carrinho.", corpo: "Quer saber o peso das compras." },
    { fundo: "supermercado", cat: ["alimento"], titulo: "As sacolas têm um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "cidade", cat: ["alimento"], titulo: "Levando as sacolas para casa.", corpo: "Escolha o que levar sem passar do peso." },
    { fundo: "padaria", cat: ["alimento", "bebida"], titulo: "Última parada na padaria.", corpo: "Completou as compras cuidando do dinheiro E do peso." },
    { fundo: "supermercado", cat: ["alimento", "bebida"], titulo: "Fechando as compras da semana.", corpo: "Falta só respeitar todas as regras." },
  ],

  objetos: [
    { fundo: "papelaria", cat: ["escolar"], titulo: "{p} está voltando às aulas!", corpo: "Na papelaria, comprou o material da lista. Some o preço." },
    { fundo: "livraria", cat: ["escolar"], titulo: "Passando na livraria.", corpo: "Escolheu cadernos novos. Quanto custam juntos?" },
    { fundo: "livraria", cat: ["escolar"], titulo: "Faltava um caderno especial.", corpo: "Comprou e pagou com uma nota. Quanto recebe de troco?" },
    { fundo: "papelaria", cat: ["escolar"], titulo: "A lista de material é grande.", corpo: "Tem um limite de dinheiro. Escolha sem estourar." },
    { fundo: "brinquedos", cat: ["objeto"], titulo: "Na loja de brinquedos.", corpo: "Vai levar vários iguais para o recreio." },
    { fundo: "padaria", cat: ["fruta"], titulo: "Hora do lanche.", corpo: "Dividiu as frutas igualmente com os colegas." },
    { fundo: "papelaria", cat: ["escolar"], titulo: "Enchendo a mochila.", corpo: "Quer saber o peso de todo o material." },
    { fundo: "cidade", cat: ["escolar"], titulo: "A mochila tem um peso máximo.", corpo: "Quanto ainda cabe sem passar do limite?" },
    { fundo: "papelaria", cat: ["objeto", "escolar"], titulo: "Nem tudo cabe na mochila.", corpo: "Escolha o que levar sem passar do peso." },
    { fundo: "padaria", cat: ["alimento"], titulo: "Comprando o lanche da semana.", corpo: "Controla o dinheiro E o peso da sacola." },
    { fundo: "papelaria", cat: ["escolar", "objeto"], titulo: "Tudo pronto para a escola!", corpo: "Falta só respeitar as regras." },
  ],
};
