...
export const DIFFICULTY_DEFINITIONS: Record<string, Record<number, string>> = {
  ...
  "sequenciamento": {
    ...
    2: "4 passos simples",
    3: "5 passos simples",
    4: "4 passos complexos",
    5: "5 passos complexos",
    6: "6 passos com dependências",
    7: "7 passos com dependências",
    8: "8 passos complexos",
    9: "Múltiplas sequências paralelas",
    10: "Planejamento multi-etapa",
  },
  "flexibilidade-cognitiva": {
    1: "2 regras, poucas trocas",
    2: "2 regras, trocas moderadas",
    3: "2 regras, muitas trocas",
    4: "3 regras, poucas trocas",
    5: "3 regras, trocas moderadas",
    6: "3 regras, muitas trocas",
    7: "4 regras",
    8: "4 regras velocidade",
    9: "Regras ambíguas",
    10: "Regras dinâmicas",
  },
};
