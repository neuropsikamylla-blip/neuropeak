...
export const EXERCISE_META: Record<string, ExerciseMeta> = {
  ...
  "letras-sequencia": { type: "verbal", difficulty: "medio", secondary: ["Memória Operacional", "Atenção Sustentada"] },
  "sequencia-itens": { type: "visual", difficulty: "medio", secondary: ["Memória Operacional", "Atenção Visual"] },
  ...
  "vigilancia": { type: "visual", difficulty: "medio", secondary: ["Atenção Sustentada", "Tempo de Reação"] },
  // Funções Executivas
  ...
  "estacionamento-logico": { type: "espacial", difficulty: "dificil", secondary: ["Planejamento", "Resolução de Problemas"] },
