...
export const DOMAIN_SUBDOMAINS: Record<Domain, Subdomain[]> = {
  memory: [
    { id: "operacional", label: "Memória Operacional", exercises: ["span-numerico", "span-numerico-inverso", "letras-sequencia", "sequencia-itens", "desafio-supermercado", "desafio-supermercado-auditivo"] },
