# 16 — Espelho do catálogo canônico (auditoria)

> A fonte oficial é [`docs/architecture/CANONICAL_EXERCISES.md`](../architecture/CANONICAL_EXERCISES.md).
> Este documento é apenas um espelho da auditoria, limitado aos 34 exercícios ACTIVE.
