      ...
      <AnimatePresence mode="wait">
        ...
        {phase === "exercise" && (
          ...
          >
            ...
            {/* Botão de tela cheia (opcional). Obs.: a tela cheia nativa do macOS
                cria um "Espaço" separado — se estiver atendendo por Zoom com
                controle remoto e os cliques do paciente pararem, saia da tela
                cheia (Esc) e use em janela normal. */}
            <button
