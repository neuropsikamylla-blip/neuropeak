            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-slate-300">{option.unitsLabel}</p>
                </div>
                <p className="shrink-0 text-[11px] font-semibold text-blue-200">{option.durationLabel}</p>
              </div>
              <p className="mt-1.5 text-[11px] leading-relaxed text-slate-400">{option.guidance}</p>
              {option.exposureNote && <p className="mt-1 text-[11px] font-medium text-slate-300">{option.exposureNote}</p>}
              {option.adaptiveValidityNote && (
                <p className="mt-1.5 rounded-md bg-amber-300/10 px-2 py-1.5 text-[11px] leading-relaxed text-amber-100">
                  {option.adaptiveValidityNote}
                </p>
              )}
            </button>
