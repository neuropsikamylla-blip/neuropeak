...
2. **Decisões de produto/migração:** C2 (pinPlain — eu faço código+schema, você roda o `db push` em prod), SEC-04 (CRP gate server-side), A1-completo (score server-side).
